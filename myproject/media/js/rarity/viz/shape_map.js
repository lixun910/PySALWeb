...
define( ["mapshaper","rtree", "../weights/weights"], function(mapshaper, RTree, W) {

var ShapeMap = function(fname, content, prj, LL, Lmap) {
  ...
  mapshaper.MapShaper.setLayerName(dataset.layers[0], fname);
